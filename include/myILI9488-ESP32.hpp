...
// SPIバスの設定
      ...
      cfg.pin_sclk = 25;//18;            // SPIのSCLKピン番号を設定
      cfg.pin_mosi = 26;//23;            // SPIのMOSIピン番号を設定
      cfg.pin_miso = -1;//32;//19;            // SPIのMISOピン番号を設定 (-1 = disable)
      cfg.pin_dc   = 27;//17;            // SPIのD/Cピン番号を設定  (-1 = disable)
...
//*/
    ...
    { // 表示パネル制御の設定を行います。
      ...
      cfg.pin_cs           =    12;//5;  // CSが接続されているピン番号   (-1 = disable)
      cfg.pin_rst          =    -1;//14;//16;  // RSTが接続されているピン番号  (-1 = disable)
